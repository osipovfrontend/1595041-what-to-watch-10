          ...
          <div className="film-card__info">
            ...
            <div className="film-card__desc">
              ...
              <div className="film-rating">
                <div className="film-rating__score">{film.scoreRating}</div>
                <p className="film-rating__meta">
                  <span className="film-rating__level">{film.levelRating}</span>
                  <span className="film-rating__count">{film.countRating} ratings</span>
                </p>
              </div>
